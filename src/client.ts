...
import {
  ToolCountMessagesParams,
  ToolCreateEmptyIflowParams,
  ToolCreateEmptyIflowResponse,
  ToolCreateEmptyMappingParams,
  ToolCreateMappingTestIflowParams,
  ToolCreatePackageParams,
  ToolCreatePackageResponse,
  ToolDeployIflowParams,
  ToolDeployMessageMappingParams,
  ToolDiscoverPackagesResponse,
  ToolListAllIflowsParams,
  ToolListPackagesResponse,
  ToolRetrieveDeployErrorParams,
  ToolRetrieveDocsParams,
  ToolRetrieveIflowConfigurationsParams,
  ToolRetrieveIflowEndpointsParams,
  ToolRetrieveIflowExampleParams,
  ToolRetrieveIflowImageParams,
  ToolRetrieveIflowParams,
  ToolRetrieveIflowResponse,
  ToolRetrieveMappingExampleParams,
  ToolRetrieveMessageMappingParams,
  ToolRetrieveMessagesParams,
  ToolRetrievePackageParams,
  ToolRetrievePackageResponse,
  ToolSearchDocsParams,
  ToolSendHTTPMessageParams,
  ToolUpdateIflowParams,
  ToolUpdateMessageMappingParams,
  Tools,
...
export interface ClientOptions {
  /**
   * Defaults to process.env['MCP_IS_API_KEY'].
   */
   ...
   *
   * Defaults to process.env['MCP_IS_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['MCP_IS_LOG'] or 'warn' if it isn't set.
   */
...
/**
 * API Client for interfacing with the Mcp Is API.
 */
export class McpIs {
  apiKey: string | null;
   ...
   * API Client for interfacing with the Mcp Is API.
   *
   * @param {string | null | undefined} [opts.apiKey=process.env['MCP_IS_API_KEY'] ?? null]
   * @param {string} [opts.baseURL=process.env['MCP_IS_BASE_URL'] ?? http://localhost:8080] - Override the default base URL for the API.
   ...
   */
  constructor({
    baseURL = readEnv('MCP_IS_BASE_URL'),
    apiKey = readEnv('MCP_IS_API_KEY') ?? null,
    ...opts
  }: ClientOptions = {}) {
    ...
    this.timeout = options.timeout ?? McpIs.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('MCP_IS_LOG'), "process.env['MCP_IS_LOG']", this) ??
      defaultLogLevel;
  ...
  static McpIsError = Errors.McpIsError;
...
export declare namespace McpIs {
